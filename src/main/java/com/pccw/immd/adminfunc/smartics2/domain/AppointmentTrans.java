...
public class AppointmentTrans  implements java.io.Serializable {
    ...
    public AppointmentTrans(long trn, long ern, short appId, String enqCode, Date transTime, String commLang, String commChannel, String isNotSent, String isRemSent, String virtualInd, String action, String active, Date createDate, String createBy, Date lastUpdDate, String lastUpdBy) {
        this.trn = trn;
        this.ern = ern;
        this.appId = appId;
    ...
    public AppointmentTrans(long trn, long ern, Long preErn, Long preTrn, short appId, String exportStatus, String interfaceFile, String controlFile, Date exportTime, String enqCode, Date transTime, String commLang, String commChannel, String commParameter, String faxInd, String isNotSent, String isRemSent, String virtualInd, String action, String active, Date createDate, String createBy, Date lastUpdDate, String lastUpdBy) {
       this.trn = trn;
       this.ern = ern;
       this.preErn = preErn;
       this.preTrn = preTrn;
    ...
    @Column(name="TRN", unique=true, nullable=false, precision=16, scale=0)
    public long getTrn() {
        return this.trn;
    }
    ...
    @Column(name="ERN", nullable=false, precision=16, scale=0)
    public long getErn() {
        return this.ern;
    }
    ...
    @Column(name="ENQ_CODE", nullable=false, length=4)
